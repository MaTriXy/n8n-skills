...
- `n8n-expression-syntax-v1.8.0.zip` - n8n expression syntax and common patterns
- `n8n-mcp-tools-expert-v1.8.0.zip` - Expert guide for using n8n-mcp tools (recommended to install first)
- `n8n-workflow-patterns-v1.8.0.zip` - 6 proven workflow architectural patterns
- `n8n-validation-expert-v1.8.0.zip` - Validation error interpretation and fixing
- `n8n-node-configuration-v1.8.0.zip` - Operation-aware node configuration
- `n8n-code-javascript-v1.8.0.zip` - JavaScript in n8n Code nodes
- `n8n-code-python-v1.8.0.zip` - Python in n8n Code nodes
...
- **`n8n-mcp-skills-v1.8.0.zip`** (174 KB) - All 7 skills in one package
...
/plugin install /path/to/n8n-mcp-skills-v1.8.0.zip
```
...
```
dist/
├── n8n-code-javascript-v1.8.0.zip        (34 KB)
├── n8n-code-python-v1.8.0.zip            (31 KB)
├── n8n-expression-syntax-v1.8.0.zip      (11 KB)
├── n8n-mcp-skills-v1.8.0.zip             (174 KB)  Claude Code only
├── n8n-mcp-tools-expert-v1.8.0.zip       (19 KB)
├── n8n-node-configuration-v1.8.0.zip     (18 KB)
├── n8n-validation-expert-v1.8.0.zip      (19 KB)
├── n8n-workflow-patterns-v1.8.0.zip      (37 KB)
└── README.md                              (this file)
```
